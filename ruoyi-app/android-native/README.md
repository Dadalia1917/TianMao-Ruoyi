...
2026 年 8 月 13 日已完成真实重启验证：引导 Activity 启动服务后返回 `com.alibaba.genie.panel`，完整助手 UI 未自动打开；悬浮球持续可见，点击后可恢复 APP。2026 年 8 月 14 日 20:04:17（UTC+8）已把语音识别优化与 Agent 音乐场景合并为 v1.1.1，覆盖安装到 `192.168.3.234:5555` 后确认 `versionCode=111`、`MainActivity` 和进程正常。正式 APK 大小 1,621,553 字节，SHA-256 为 `988B84AF6740FF0FD60907AC9B946412B6AD409E20EF6E3D6F4341A82650F458`，并已通过 v1/v2 签名校验。
...
v1.1.1 原生白名单新增 `音乐播放器/轻音乐/音乐/歌曲` 与 `播放/来一首/放一首/听`，支持 Agent 在用户确认后提交“播放一首舒缓的轻音乐”。“累了/想放松”不会在原生层转成空调或其他设备动作。
