  ...
  <view class="agreement-page">
    ...
    <view class="document-card">
      <view class="document-head">
        ...
        <text class="document-meta">更新日期：2026年8月13日　生效日期：2026年8月13日</text>
      </view>
...
const documents = {
  service: {
    title: '天猫智家用户服务协议',
    notice: '本服务包含人工智能生成内容。Qwen 等模型并非真人，其回答可能不准确，也不能替代医疗、法律、金融等专业意见。在兼容的天猫精灵智慧屏上，明确的低风险家居指令可提交给本机天猫精灵处理；提交不代表设备必然执行成功。',
    intro: [
    ...
    sections: [
      {
        title: '服务范围',
        paragraphs: ['本服务现阶段提供账号登录、Qwen3.5 Omni 实时语音对话、文字对话、会话记录和长期记忆等功能。在兼容的天猫精灵智慧屏上，本服务还可把您明确表达的灯、空调、窗帘等低风险控制指令提交给本机天猫精灵处理。当前不支持门锁、燃气、安防等高风险操作，也不提供设备状态和执行结果保证；后续接入 Home Assistant 或复杂自动化时，我们会另行说明所需权限、设备范围和风险。'],
        items: []
      },
      {
        title: '账号注册与安全',
    ...
    sections: [
      {
        ...
        items: [
          ...
          '智能家居指令：在兼容设备上，从最终语音转写中提取的必要设备名称、位置和操作短文本，用于提交给本机天猫精灵处理；该短文本不通过 ADB、终端、root 或无障碍服务执行。',
      ...
      {
        title: '信息使用目的',
        paragraphs: ['我们将上述信息用于账号登录与安全校验、提供语音和文字对话、展示历史记录、形成您授权使用的跨会话记忆、在兼容设备上向本机天猫精灵提交明确的低风险家居指令、排查故障、防范滥用，以及履行法律法规规定的义务。未经另行同意，我们不会将信息用于与上述目的无关的用途。'],
        items: []
      },
      {
        title: '委托处理与第三方服务',
