...
public class TokenService
{
    ...
    /** 长会话最多每天刷新一次 Redis 有效期，避免每个请求都写 Redis。 */
    ...
    /**
     * 验证令牌有效期。短会话在剩余20分钟内刷新，长会话按天滑动续期。
     * 
    ...
    public void verifyToken(LoginUser loginUser)
    {
        ...
        long refreshThreshold = Math.max(MILLIS_MINUTE_TWENTY, expireTime * MILLIS_MINUTE - MILLIS_DAY);
        if (expireAt - currentTime <= refreshThreshold)
        {
            refreshToken(loginUser);
        }
    }
