...
| 当前阶段 | v1.1.0 回声抑制与 ContentProvider 直连修复包已完成构建；待将本次 APK 安装到 T10S 后复测语音控制主链路 |
...
- APK SHA-256：`13CEB75A1A1AA4CABCD8570608C66D763A4CF1D2CBDBFBA603657694E7346E1E`。
- 2026 年 8 月 13 日现场日志暴露了扬声器回灌和 Provider 元数据预检误判；两项均已修复并重新签名。独立普通第三方探针已证明 Provider 可由普通应用 UID 调用，本次主应用修复包仍需安装到 T10S 做最终端到端复测。
